...
{
	temp_passenger = start;
	cout << "Reservation Number\t\tFirst Name\t\tLast Name\t\tID\t\tPhone Number\t\tSeat Number" << endl;
	while (temp_passenger != NULL)
	{
		cout << temp_passenger->reservation_number << "\t\t\t\t" << temp_passenger->fname << "\t\t\t\t" << temp_passenger->lname << "\t\t\t\t" << temp_passenger->ID << "\t\t\t\t" << temp_passenger->phone_number << "\t\t\t\t" << temp_passenger->seat_number << "\t\t\t\t" << endl;
		temp_passenger = temp_passenger->next;
	}
}
